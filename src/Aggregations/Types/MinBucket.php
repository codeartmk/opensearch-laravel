...
/**
 * A `min_bucket` pipeline aggregation: the smallest value of a metric across the buckets of a sibling aggregation,
 * and the keys of the buckets that hold it.
 *
 * @see https://opensearch.org/docs/latest/aggregations/pipeline/min-bucket/
 */
class MinBucket implements OpenSearchQuery, AggregationType
{
    ...
    /**
     * @return array{min_bucket: array{buckets_path: string, gap_policy?: string}}
     */
