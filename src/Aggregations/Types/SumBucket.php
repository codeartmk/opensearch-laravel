...
/**
 * A `sum_bucket` pipeline aggregation: the total of a metric across the buckets of a sibling aggregation.
 *
 * @see https://opensearch.org/docs/latest/aggregations/pipeline/sum-bucket/
 */
class SumBucket implements OpenSearchQuery, AggregationType
{
    /**
    ...
    /**
     * @return array{sum_bucket: array{buckets_path: string, gap_policy?: string}}
     */
    public function toOpenSearchQuery(): array
    {
        ...
        if (!is_null($this->gapPolicy)) {
            $query['sum_bucket']['gap_policy'] = $this->gapPolicy;
        }
